...
function Card(props) {
   ...
   <Flex align="flex-start" direction='column' width='70%' boxShadow="md" p="6" rounded="md" bg="white" border="1px" borderColor='whatsapp.200' m={7} bgColor='white'>
                <Flex width="100%">
...
export default connect(({ questions, users,authedUser }, { match }) =>{ 
