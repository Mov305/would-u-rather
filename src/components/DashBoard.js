...
function DashBoard(props) {
    ...
    return (
        <Flex pos='relative'  >
            ...
            <Flex m={4}  borderLeft='1px' borderLeftColor='green.100' rounded='md' direction={['column','row','column']}   width={['100%','100%',"20%"]} style={{background:'rgba(250,250,250,0.7)'}}>
                <Heading size={['md','md','lg','lg']}  p={6}  > CATEGORIES </Heading>
            ...
            <Box width={['100%','100%','70%']} pos='absolute' top={[200,100,0]} left={['10%',"10%",'30%']}>
                {ids ?
